...
/* SESIONES */
if ($_POST["operacion"] == "Crear-sesion") {

    $stmt = $conexion->prepare("INSERT INTO sesiones(fecha, codigo, idUsuario)VALUES(:fecha, :codigo, :idUsuario)");
...
/* ...No veo que tenga sentido editar una sesion en este caso */